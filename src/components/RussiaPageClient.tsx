...
export default function RussiaPageClient() {
      ...
      <div className="container">
        ...
        <main>
          ...
          <section className="history">
            ...
            <p>In deze moeilijke tijd zocht Rusland toenadering tot het Westen. President Boris Jeltsin probeerde een partnerschap op te bouwen. Rusland kreeg financiële hulp en er werden gesprekken gevoerd over samenwerking. Het Westen beloofde, volgens de Russische lezing nu, dat de <a id="source-navo-1" href="#term-navo" className="term-link"><strong>NAVO</strong></a>, het militaire bondgenootschap van het Westen, niet "één inch" naar het oosten zou uitbreiden. Dit was een belangrijke belofte voor de Russen, hoewel die nooit op papier is bevestigd, omdat Rusland zich na decennia van vijandschap onveilig voelden.</p>
